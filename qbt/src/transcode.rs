/// Transcodes the temporary VP9 file into a WebM AV1 file.
...
pub(crate) const TIMESTAMP_SCALE_NANOS: u64 = 1_000_000;
...
impl PixelBufferPool {
    ...
    pub fn new(mut freed_buffers: mpsc::Receiver<Vec<u8>>, buffer_size: usize) -> Self {
        ...
        let inner = Arc::new(Mutex::new(crate::transcode::PixelBufferPoolInner {
...
pub(crate) struct ThreadedEncoder<W: std::io::Write> {
